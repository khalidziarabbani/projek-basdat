...
if(isset($_POST['submit'])){
    ...
    $sql2 = "INSERT INTO formsewa(user_id, id_keranjang, nama, no_telp, alamat, tanggal, nama_mobil, estimasi) VALUES('$user_id', '$id_keranjang','$nama_penyewa', '$no_telp', '$alamat', '$tanggal', '$nama_mobil', '$estimasi')";
    $query2 = mysqli_query($conn, $sql2);

    if ($query2) {
        $sql3 = "DELETE FROM keranjang WHERE id_keranjang = $id_keranjang";
